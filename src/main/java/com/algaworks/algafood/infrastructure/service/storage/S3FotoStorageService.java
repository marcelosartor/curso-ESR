...
public class S3FotoStorageService implements FotoStorageService {
	...
	public void armazenar(NovaFoto novaFoto) {
		try {
			...
			throw new StorageException("Não foi possivel enviar o aquivo para Amazon S3",e);
		}
	}
	...
	public void remover(String nomeArquivo) {
		try {
			...
			throw new StorageException("Não foi possivel excluir o aquivo na Amazon S3",e);
		}
	}
