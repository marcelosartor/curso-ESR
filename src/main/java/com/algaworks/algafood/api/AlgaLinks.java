...
public class AlgaLinks {
	...
	public Link linkToPedidos(String rel) {
		...
		String template = linkTo(PedidoController.class).toUri().toString();
		...
		return Link.of(UriTemplate.of(template, PAGINACAO_VARIABLES.concat(filtroVariables)),rel);
	}
	...
	public Link linkToEstado(Long estadoId, String rel) {
	    return linkTo(methodOn(EstadoController.class)
	            .buscar(estadoId,null)).withRel(rel);
	}
